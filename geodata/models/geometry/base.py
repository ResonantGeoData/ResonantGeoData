...
class GeometryArchive(ModifiableEntry, PostSaveEventModel):
    ...
    archive_file = models.FileField(upload_to='geometry_files', validators=[validate_zip_extension,], help_text='This must be an archive (`.zip`) of a single shape (`.shp`, `.dbf`, `.shx`, etc.).')
