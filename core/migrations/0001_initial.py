    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('algorithmresult', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.AlgorithmResult')),
                ('groundtruth', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Groundtruth')),
                ('scorealgorithm', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.ScoreAlgorithm')),
            ],
        ),
        migrations.AddField(
