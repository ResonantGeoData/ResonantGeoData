# Generated by Django 3.2.5 on 2021-08-12 17:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'process_type',
                    models.CharField(
                        choices=[('arbitrary', 'Arbitrarily compiled externally')],
                        default='arbitrary',
                        max_length=20,
                    ),
                ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name='_rgd_imagery_compiledimages_ancillary_files_+',
                        to='rgd.ChecksumFile',
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name='_rgd_imagery_compiledimages_processed_images_+',
                ...
                (
                    'source_images',
                    models.ManyToManyField(
                        related_name='_rgd_imagery_compiledimages_source_images_+',
                        to='rgd_imagery.Image',
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'source_images',
                    models.ManyToManyField(
                        through='rgd_imagery.ProcessedImage', to='rgd_imagery.Image'
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to='rgd_imagery.processedimagegroup',
            ),
        ),
        migrations.AddField(
            model_name='processedimage',
